...
import * as data from './mockData/data.json' //grab data from json file, had to set "resolveJsonModule" to true in tsconfig to allow this import
...
export class AppComponent {
  ...
  data = Array.from(data) //grab data from json file and convert to array
